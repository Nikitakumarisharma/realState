  ...
  <Link href="/">
    ...
    />
      ...
      <div
        ...
        } absolute lg:static top-16 left-0 w-full lg:w-auto bg-gray-900 lg:bg-transparent z-40 lg:flex-row flex-col text-center py-6 lg:py-0 transition-all duration-300 ease-in-out opacity-90`}
      >
        <div className="lg:flex lg:space-x-6 flex flex-col lg:flex-row items-center">
          <Link
            href="/"
            className="text-gray-300 hover:text-white py-2 block lg:inline"
          ...
          {user ? (
            ...
            <Link
              href="/login"
              className="text-blue-400 hover:text-blue-500 py-2 block lg:inline"
              onClick={() => setMenuOpen(false)}
            >
              Login
            </Link>
